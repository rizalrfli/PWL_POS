          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control @error('supplier_nama') is-invalid @enderror"
                     id="supplier_nama" name="supplier_nama" value="{{ old('supplier_nama') }}"
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <textarea class="form-control @error('supplier_alamat') is-invalid @enderror"
                        ...
                        placeholder="Masukkan alamat supplier" rows="3">{{ old('supplier_alamat') }}</textarea>
          ...
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="text" class="form-control @error('supplier_telepon') is-invalid @enderror"
                     id="supplier_telepon" name="supplier_telepon" value="{{ old('supplier_telepon') }}"
